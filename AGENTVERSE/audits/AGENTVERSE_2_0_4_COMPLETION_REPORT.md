...
|--------|------|---------------------|
| GitHub PAT (ghp_...3V48VXU1) | GitHub PAT | Multiple commits |
| GitHub PAT (ghp_...8VXU1) | GitHub PAT | Multiple commits |
| GitHub PAT (ghp_...2wbQcP) | GitHub PAT | Multiple commits |
| Portainer tokens (10 instances) | Portainer API | Various commits |
| N8N password (redacted) | N8N password | `complete-mcp-config.json` |
| DB password (redacted) | DB password | `scholapro/config.inc.php` |
