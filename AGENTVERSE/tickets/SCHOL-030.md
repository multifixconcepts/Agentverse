# Ticket SCHOL-030: Email_Students Module (Free)

**Status:** OPEN
**Type:** Feature
**Priority:** HIGH
**Product:** scholapro
**Affected Files:** /home/coder/premium-modules/Email_Students/
**Request:** Implement Email_Students free module (SCHOL-030) following the standard delegation chain.

## Acceptance Criteria
- Module installs and activates without PHP fatals
- Menu appears in navigation with correct profile_exceptions grants
- Student email communication works
...
## Delegation Chain
1. **feature-planner** → Create spec at `/tmp/opencode/spec_schol030.md` from demo evidence
2. **fullstack-engineer** → Implement at `/home/coder/premium-modules/Email_Students/`
