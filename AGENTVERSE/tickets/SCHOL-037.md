# Ticket SCHOL-037: Staff_Parents_Import Module (Free) — Imports Staff/Teachers/Parents

**Status:** OPEN
**Type:** Feature
**Priority:** HIGH
**Product:** scholapro
**Affected Files:** /home/coder/premium-modules/Staff_Parents_Import/
**Request:** Implement Staff_Parents_Import free module (SCHOL-037) following the standard delegation chain. **NOTE: This module imports staff/teachers/parents.**

## Acceptance Criteria
- Module installs and activates without PHP fatals
- Menu appears in navigation with correct profile_exceptions grants
- Staff, teacher, and parent import functionality works
...
## Delegation Chain
1. **feature-planner** → Create spec at `/tmp/opencode/spec_schol037.md` from demo evidence
2. **fullstack-engineer** → Implement at `/home/coder/premium-modules/Staff_Parents_Import/`
