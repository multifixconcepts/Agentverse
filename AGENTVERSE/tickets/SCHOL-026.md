# Ticket SCHOL-026: Email Module (Free)

**Status:** OPEN
**Type:** Feature
**Priority:** HIGH
**Product:** scholapro
**Affected Files:** /home/coder/premium-modules/Email/
**Request:** Implement Email free module (SCHOL-026) following the standard delegation chain.

## Acceptance Criteria
- Module installs and activates without PHP fatals
- Menu appears in navigation with correct profile_exceptions grants
- Email sending/receiving functionality works
...
## Delegation Chain
1. **feature-planner** → Create spec at `/tmp/opencode/spec_schol026.md` from demo evidence
2. **fullstack-engineer** → Implement at `/home/coder/premium-modules/Email/`
