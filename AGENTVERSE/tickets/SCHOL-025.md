# Ticket SCHOL-025: Attendance_Excel_Sheet Module (Free)

**Status:** OPEN
**Type:** Feature
**Priority:** HIGH
**Product:** scholapro
**Affected Files:** /home/coder/premium-modules/Attendance_Excel_Sheet/
**Request:** Implement Attendance_Excel_Sheet free module (SCHOL-025) following the standard delegation chain.

## Acceptance Criteria
- Module installs and activates without PHP fatals
- Menu appears in navigation with correct profile_exceptions grants
- Excel export/import functionality works
...
## Delegation Chain
1. **feature-planner** → Create spec at `/tmp/opencode/spec_schol025.md` from demo evidence
2. **fullstack-engineer** → Implement at `/home/coder/premium-modules/Attendance_Excel_Sheet/`
