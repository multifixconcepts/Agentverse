# Ticket SCHOL-029: Email_Parents Module (Free)

**Status:** OPEN
**Type:** Feature
**Priority:** HIGH
**Product:** scholapro
**Affected Files:** /home/coder/premium-modules/Email_Parents/
**Request:** Implement Email_Parents free module (SCHOL-029) following the standard delegation chain.

## Acceptance Criteria
- Module installs and activates without PHP fatals
- Menu appears in navigation with correct profile_exceptions grants
- Parent email communication works
...
## Delegation Chain
1. **feature-planner** → Create spec at `/tmp/opencode/spec_schol029.md` from demo evidence
2. **fullstack-engineer** → Implement at `/home/coder/premium-modules/Email_Parents/`
