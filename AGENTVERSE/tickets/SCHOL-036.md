# Ticket SCHOL-036: Staff_Absences Module (Free) — Has Email Notifications

**Status:** OPEN
**Type:** Feature
**Priority:** HIGH
**Product:** scholapro
**Affected Files:** /home/coder/premium-modules/Staff_Absences/
**Request:** Implement Staff_Absences free module (SCHOL-036) following the standard delegation chain. **NOTE: This module has email notifications.**

## Acceptance Criteria
- Module installs and activates without PHP fatals
- Menu appears in navigation with correct profile_exceptions grants
- Staff absence tracking and reporting works
- Email notifications for absences function correctly
...
## Delegation Chain
1. **feature-planner** → Create spec at `/tmp/opencode/spec_schol036.md` from demo evidence
2. **fullstack-engineer** → Implement at `/home/coder/premium-modules/Staff_Absences/`
