...
/**
 * Format a "Print Receipt" link for a payment row.
 *
 * @param  string $value   The payment ID value.
 * @param  string $column  The column name.
 * @return string          HTML link to PaymentReceipt.php.
 */
function _makePaymentReceiptLink( $value, $column )
{
	global $THIS_RET;

	$payment_id = $THIS_RET['ID'];

	return '<a href="Modules.php?modname=Student_Billing/PaymentReceipt.php&receipt_id=' . $payment_id . '&student_id=' . UserStudentID() . '" target="_blank">' . _( 'Print Receipt' ) . '</a>';
}
